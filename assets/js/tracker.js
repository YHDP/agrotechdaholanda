/* Medição própria da Agrotech da Holanda.
 *
 * Copiado de regenstudio-website/assets/js/tracker.js, que já é multi-site: o pipeline no
 * Supabase filtra por `SITE`, então este domínio reporta sob a sua própria chave sem tocar
 * em nada do outro site.
 *
 * SEM COOKIES. SEM localStorage. Uma única chave em sessionStorage, do escopo da aba, para
 * saber de qual página do site você veio. O IP não é guardado: o fuso horário serve de noção
 * grosseira de país. Os eventos brutos são apagados após 48 horas.
 *
 * É por isso que este site não tem aviso de cookies — ver /privacidade.html.
 */
/**
